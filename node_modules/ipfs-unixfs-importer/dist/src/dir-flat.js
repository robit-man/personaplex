...
import { InvalidShardingStrategyError } from "./index.js";
import { dataFieldSerializedSize, linkSerializedSize, utf8ByteLength } from "./utils/pb-size.js";
...
function calculateLinkSize(nameBytes, child) {
    if (child?.cid != null && child?.size != null) {
        return linkSerializedSize(nameBytes, child.cid.byteLength, Number(child.size));
    }
    return 0;
}
