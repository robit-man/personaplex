...
export function decodeAuthorizationHeader(header) {
...
export async function genOpaque(privateKey, unwrapped) {
    return signBox(privateKey, unwrapped);
}
export async function unwrapOpaque(publicKey, data) {
    const unwrapped = await verifyBox(publicKey, data.opaque);
...
export async function signBox(key, data) {
...
export async function verifyBox(key, data) {
...
export async function genBearerToken(serverKey, clientPeerId, hostname) {
