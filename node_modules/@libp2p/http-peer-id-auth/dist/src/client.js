...
export function isClientChallengeResponse(obj) {
    if (obj == null) {
        return false;
    }
...
export function isServerChallenge(obj) {
    if (obj == null) {
        return false;
    }
    return typeof obj['challenge-client'] === 'string' &&
...
export function isBearerToken(obj) {
    if (obj == null) {
        return false;
    }
 ...
 */
export async function verifyClientChallengeResponse(authHeader, hostname, clientKey, opts = {}) {
...
export async function respondToServerChallenge(serverChallenge, hostname, clientKey) {
...
export async function decodeBearerToken(authHeader, clientKey, challenge, hostname, serverPublicKey) {
...
export class ClientInitiatedHandshake {
    ...
    serverId;
    bearer;
    constructor(clientKey, hostname, verifyPeer) {
        this.state = 'init';
     ...
     */
    async verifyServer(header, opts) {
...
export class ServerInitiatedHandshake {
     ...
     */
    async answerServerChallenge(header, opts) {
        if (this.state !== 'init') {
     ...
     */
    async decodeBearerToken(header) {
        if (this.state !== 'challenge-server') {
            throw new InvalidStateError(`Client Initiated Handshake state was "${this.state}" and not "challenge-server"`);
        }
        const message = decodeAuthorizationHeader(header);
