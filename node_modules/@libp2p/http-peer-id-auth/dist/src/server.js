...
export async function issueBearerToken(data, hostname, serverKey, tokenTTL) {
...
export async function respondToClientChallenge(clientChallenge, hostname, serverKey) {
...
export async function respondToServerChallengeResponse(response, hostname, serverKey) {
...
export async function unwrapBearerToken(token, expectedHostname, privateKey, tokenTTL) {
