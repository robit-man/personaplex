...
| [DIVERSE_SYNTHESIS_CASCADE_CONTRACT.md](DIVERSE_SYNTHESIS_CASCADE_CONTRACT.md) | Agent-operable cascade for diverse, counterfactual, evidence-conditioned source-corpus generation. |
