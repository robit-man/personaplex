...
exec env \
  ...
  PERSONAPLEX_CONTROL_MODELS="${PERSONAPLEX_CONTROL_MODELS:-$PERSONAPLEX_CONTROL_MODEL}" \
  PERSONAPLEX_CONTROL_NUM_CTX="$PERSONAPLEX_CONTROL_NUM_CTX" \
  PERSONAPLEX_CONTROL_MAX_TOKENS="${PERSONAPLEX_CONTROL_MAX_TOKENS:-384}" \
  PERSONAPLEX_CONTROL_UPSTREAM_TIMEOUT_MS="${PERSONAPLEX_CONTROL_UPSTREAM_TIMEOUT_MS:-90000}" \
